...
public class record  extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        ...
        String stream_key = intent.getStringExtra("stream_key");//TODO add key in the intent and remove the first definition of ffmpeg_link
        ffmpeg_link = "rtmp://live.mux.com/app/"+stream_key;
