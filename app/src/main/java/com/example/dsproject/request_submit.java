...
public class request_submit  extends AppCompatActivity {
    ...
    private String tag="tag_request_submit";

   // private String item_name[]= new String[30];
   // private int item_id[]=new int[30];


private Button request_submit_btn;
private EditText request_submit_description;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        request_submit_btn=(Button)findViewById(R.id.request_submit_btn);
        request_submit_description=(EditText)findViewById(R.id.request_submit_description);
        ...
        request_submit_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             if(request_submit_description.equals("")){
                 Toast toast = Toast.makeText(getApplicationContext(), "Please add a description", Toast.LENGTH_SHORT);
                 toast.show();
             }
...
private class httpGET2 extends AsyncTask {
    ...
    protected void onPostExecute(Object result) {
        ...
        Toast toast1 = Toast.makeText(getApplicationContext(), "Request sent", Toast.LENGTH_LONG);
        toast1.show();
        finish();
